...
Tagline: **Skills to shape your future**
...
Alternatief 1 en 2 voeren dezelfde inkt: witte wordmark, oranje icoon met een witte omlijning eromheen. Alleen de grond verschilt. Die omlijning zit ook op de tegels EA en EB, en ontbreekt bij de origineel-versies.

---

# DPS, De Presenteerschool

Tagline: **Partner van School for Professionals**
...
Tweekleurige wordmark: PRESENTEER staat in cyaan, op de merkkleur in wit.
...
Geen tertiair. Tint 1 komt uit paars, want het geel is te licht voor de band.
...
Tint 1 en 2 komen uit het blauw, want het geel is te licht voor de band.
...
Tweekleurige wordmark: SCHRIJF staat in `#FF9F1C`, op de merkkleur in wit.

---

# SLB, Stephan Borggreve

Tagline: **Eigenaar van School for Professionals**
...
Wit draagt de basis en is daarmee een volwaardige hoofdkleur. De drie tinten komen uit navy, niet uit groen.
...
Bestanden in `logos/slb/`. Type D heet bij dit merk **eigenaarslogo**.

De drie gronden zijn `#FFFFFF`, `#242E51` en `#23D366`. De tegels EA en EB staan op navy en groen.

Groen is uitsluitend achtergrond, nooit inkt.

---

# SwS, SpeakwithSteve

Tagline: **Partner of School for Professionals**
...
Geen tertiair. Dit merk voert geen geel.
...
De drie gronden zijn `#FFFFFF`, `#3A2B58` en `#00BF63`. De tegels EA en EB staan op paars en groen.
...
Geen tint 1: het geel ligt op L\*88.3, boven de band van 80 tot 86. Wit vult hier de rol van tertiair.
...
| Merk | H1 | H2 tot H6 | Woordafstand H1 | Bodykleur |
|---|---|---|---|---|
| SFP | Archivo Black 400 | Archivo 900 | niet van toepassing | `#000000` |
| DPS | Nunito 900 | Nunito 900 | niet van toepassing | `#575757` |
| DGA | Rubik Mono One 400 | Rubik 900 | `-0.43em` | `#575757` |
| CVD | Nunito 900 | Nunito 900 | niet van toepassing | `#575757` |
| DST | Rubik Mono One 400 | Rubik 900 | `-0.43em` | `#575757` |
| SLB | Rubik Mono One 400 | Rubik 900 | `-0.43em` | `#575757` |
| SwS | Rubik Mono One 400 | Rubik 900 | `-0.43em` | `#575757` |
| FL | Rubik Mono One 400 | Rubik 900 | `-0.43em` | `#000000` |
...
Rubik Mono One is monospace, dus de spatie is even breed als een letter en de woordgaten worden te groot. Corrigeer met `word-spacing: -0.43em`. Die waarde is grootte-onafhankelijk.

### Wordmarks

De wordmarks van DPS, DGA, CVD en DST staan aaneengeschreven, zonder spaties. Dat is bewust en netwerkbreed. DPS en DST voeren een tweekleurige wordmark: bij DPS staat PRESENTEER in cyaan, bij DST staat SCHRIJF in oranje, en op de merkkleur in wit.
...
| B | icoon |
| C | favicon: het beeldmerk op een ronde schijf van 1000x1000 in de grondkleur van die versie |
...
`{code}-{merk}-{typenaam}-{versienaam}.{ext}`, bijvoorbeeld `ab-de-presenteerschool-logo-alternatief-1.svg`. Alles in kleine letters met koppeltekens, zodat een raw-URL geen spaties of haakjes bevat. Dit stelsel geldt ook voor de merkmappen in `Documents/School for Professionals`.
